    ...
    return (
        <header className="sticky top-0 z-50 shadow">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-3">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        {/* Updated logo with "Portfolio" in half gray and half orange */}
                        <span className="text-3xl font-bold transition-transform duration-200 hover:scale-105">
                            <span className="text-gray-800">Port</span>
                            <span className="text-orange-600">folio</span>
                        </span>
                    </Link>
                    <div className="flex items-center lg:order-2 ">
                        ...
                        <div className="hidden lg:block ">
                            ...
                            <Link
                                to="#"
                                className="text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2"
                            >
                                Get started
                            </Link>
                        </div>
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        `block py-2 pr-4 pl-3 duration-200 ${isActive ? 'text-orange-600 font-semibold' : 'text-gray-700'}
            ...
            ${isActive ? 'text-orange-600' : ''}`
                            ...
                            <Link
                                to="#"
                                className="block mt-4 text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-3"
                                onClick={handleMenuToggle} // Close menu on click
                            >
                                Get started
                            </Link>
